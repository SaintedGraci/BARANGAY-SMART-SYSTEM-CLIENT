        ...
        <CardContent className="p-5 sm:p-6">
            ...
            <div className="flex items-center gap-3.5">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-slate-500 mt-0.5">
                  Track real-time status and request official barangay certificates online
                </p>
              </div>
            </div>
          ...
          <div className="mt-6 space-y-4 pt-4 border-t border-slate-100">
            ...
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search by document type, purpose, or remarks…"
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="w-full pl-10 pr-4 py-2.5 bg-slate-50/80 border border-slate-200 rounded-xl text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
              />
            </div>
