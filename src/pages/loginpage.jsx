  ...
  return (
    <div className="h-screen bg-gradient-to-br from-gray-50 via-white to-purple-50 flex relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        {/* Vertical divider */}
        <div className="absolute top-20 bottom-20 left-1/2 transform -translate-x-1/2 w-px bg-gradient-to-b from-transparent via-purple-200 to-transparent hidden lg:block"></div>
      </div>

      {/* LEFT SIDE - Resident Illustration */}
      <div className="relative z-10 flex-1 flex-col items-center justify-center px-8 lg:px-12 bg-gradient-to-br from-white to-gray-50 hidden lg:flex">
        <div className="w-full max-w-md flex flex-col items-center">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-base text-purple-600 font-semibold">Resident Portal</p>
          </div>
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center px-6 sm:px-8 lg:px-12 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="flex justify-center mb-6 lg:hidden">
            <button
              ...
              aria-label="Go to home page"
            >
              <div className="absolute -inset-2 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full blur-lg opacity-30 group-hover:opacity-50 transition duration-300"></div>
              <div className="relative w-16 h-16 rounded-full bg-gradient-to-br from-white to-gray-50 border-4 border-purple-200 group-hover:border-purple-400 p-2 shadow-xl group-hover:shadow-2xl transition-all duration-300">
                <img
                  src={bakilidLogo}
                  alt="Barangay Bakilid Logo"
                  className="w-full h-full object-contain"
          ...
          <div className="flex justify-center mb-5">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-50 to-blue-50 rounded-full border-2 border-purple-200 shadow-lg">
              ...
              <span className="text-xs font-semibold text-purple-700">Resident Access Portal</span>
            </div>
          </div>
          ...
          <div className="text-center mb-6">
            ...
            <h1 className="text-3xl font-bold text-gray-800 mb-2 tracking-tight">
              Login as <span className="bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">Resident</span>
            </h1>
            <p className="text-gray-500 text-sm">Access your resident dashboard securely</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-500 ml-1">Use your resident username (not email)</p>
            </div>
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="inline-flex items-center cursor-pointer">
                <input
                  ...
                  disabled={isLoading}
                  className="w-4 h-4 rounded border-gray-300 text-purple-600 focus:ring-2 focus:ring-purple-500 focus:ring-offset-0"
                />
